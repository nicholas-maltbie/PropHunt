...
namespace PropHunt.EditMode.Tests.UI
{
    ...
    /// </summary>
    [TestFixture]
    public class UIManagerTests : ECSTestsFixture
    {
        /// <summary>
        ...
        public override void Setup()
        {
            ...
            UIManager.UIEvents.ScreenChangeOccur += (object source, ScreenChangeEventArgs args) =>
            {
        ...
        [Test]
        public void UIManagerSetupUIEventsWithNullInitalState()
        {
            UIManager.UIEvents = null;
            UIManager.SetupUIEvents();

            Assert.IsTrue(UIManager.UIEvents != null);
        }
