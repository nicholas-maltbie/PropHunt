...
public class HorizontalSpinningCylinderGhostUpdateSystem : JobComponentSystem
{
    [BurstCompile]
...
#pragma warning restore 649
#endif
        [ReadOnly] public ArchetypeChunkBufferType<HorizontalSpinningCylinderSnapshotData> ghostSnapshotDataType;
        ...
        public void Execute(ArchetypeChunk chunk, int chunkIndex, int firstEntityIndex)
        {
            ...
            for (int entityIndex = 0; entityIndex < ghostEntityArray.Length; ++entityIndex)
            {
                ...
                HorizontalSpinningCylinderSnapshotData snapshotData;
...
#pragma warning restore 649
    ...
    protected override void OnCreate()
    {
        ...
        {
            All = new []{
                ComponentType.ReadWrite<HorizontalSpinningCylinderSnapshotData>(),
        ...
        {
            All = new []{
                ComponentType.ReadOnly<HorizontalSpinningCylinderSnapshotData>(),
                ComponentType.ReadOnly<GhostComponent>(),
        ...
        RequireForUpdate(GetEntityQuery(ComponentType.ReadWrite<HorizontalSpinningCylinderSnapshotData>(),
            ComponentType.ReadOnly<GhostComponent>()));
    }
    protected override JobHandle OnUpdate(JobHandle inputDeps)
    {
        ...
        if (!m_predictedQuery.IsEmptyIgnoreFilter)
        {
            var updatePredictedJob = new UpdatePredictedJob
            {
                ...
                ghostSnapshotDataType = GetArchetypeChunkBufferType<HorizontalSpinningCylinderSnapshotData>(true),
...
public partial class HorizontalSpinningCylinderGhostSpawnSystem : DefaultGhostSpawnSystem<HorizontalSpinningCylinderSnapshotData>
{
}
