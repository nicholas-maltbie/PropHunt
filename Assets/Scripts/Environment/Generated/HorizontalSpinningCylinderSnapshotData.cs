...
public struct HorizontalSpinningCylinderSnapshotData : ISnapshotData<HorizontalSpinningCylinderSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref HorizontalSpinningCylinderSnapshotData baseline1, ref HorizontalSpinningCylinderSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref HorizontalSpinningCylinderSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref HorizontalSpinningCylinderSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref HorizontalSpinningCylinderSnapshotData target, float factor)
    {
