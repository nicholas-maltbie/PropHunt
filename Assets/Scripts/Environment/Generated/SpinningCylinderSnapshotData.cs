...
public struct SpinningCylinderSnapshotData : ISnapshotData<SpinningCylinderSnapshotData>
{
    public uint tick;
    ...
    public void PredictDelta(uint tick, ref SpinningCylinderSnapshotData baseline1, ref SpinningCylinderSnapshotData baseline2)
    {
    ...
    public void Serialize(int networkId, ref SpinningCylinderSnapshotData baseline, ref DataStreamWriter writer, NetworkCompressionModel compressionModel)
    {
    ...
    public void Deserialize(uint tick, ref SpinningCylinderSnapshotData baseline, ref DataStreamReader reader,
    ...
    public void Interpolate(ref SpinningCylinderSnapshotData target, float factor)
    {
