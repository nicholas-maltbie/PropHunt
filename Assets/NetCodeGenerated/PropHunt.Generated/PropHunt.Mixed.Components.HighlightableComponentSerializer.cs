...
{
    [BurstCompile]
    public struct PropHuntMixedComponentsHighlightableComponentGhostComponentSerializer
    {
        static GhostComponentSerializer.State GetState()
        {
            ...
            if (!s_StateInitialized)
            {
                s_State = new GhostComponentSerializer.State
                {
                    ...
                    ComponentType = ComponentType.ReadWrite<PropHunt.Mixed.Components.HighlightableComponent>(),
                    ComponentSize = UnsafeUtility.SizeOf<PropHunt.Mixed.Components.HighlightableComponent>(),
        ...
        public const int ChangeMaskBits = 0;
        [BurstCompile]
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<PropHunt.Mixed.Components.HighlightableComponent>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<PropHunt.Mixed.Components.HighlightableComponent>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<PropHunt.Mixed.Components.HighlightableComponent>(backupData, 0);
        }
